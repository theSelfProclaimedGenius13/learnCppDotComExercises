...
const int input_number_chap_7_3_q1() {
	int number{};
	std::cin >> number;
	return number;
}
const bool is_greater_than_chap_7_3_q1(const int& smaller, const int& larger) {
	return bool (larger>smaller);
}
const void swap_or_not_chap_7_3_q1(int& smaller, int& larger) {
